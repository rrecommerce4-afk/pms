...
function spawnRecurrence(db, task, today) {
  ...
  const newTask = {
    ...
    startDate: isWeeklyRange ? addDays(task.startDate, 7) : today,
...
module.exports = {
  ...
  computeNextDueDate, computeWeeklyRange, spawnRecurrence, resetDailyTask, catchUpDailyTask, catchUpDailyTasks, formatRelativeTime, reopenUrl,
  buildMonthCalendar
};
